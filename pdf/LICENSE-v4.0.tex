...
Failsafe operacional & ✖️ & Opcional & Obrigatório & Obrigatório
(avançado) \\
...
Auditoria interna & ✖️ & Opcional & Obrigatória & Obrigatória
contínua \\
...
📌 RCI → DTI → LCV → MREV → Relatório de Impacto → AEV → Relatório Final
→ Selo
...
\begin{figure}
\centering
\pandocbounded{\includesvg[keepaspectratio]{fluxograma-publico.svg}}
